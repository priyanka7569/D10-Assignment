...
namespace D10_BinarySearchAndBubbleSortAssignment
{
    internal class Program
    {
        ...
        static void Main()
        {
            int size = 5; // Change this value to set the size of the array
            int[] arr = { 10, 30, 40, 90, 75, 89 };
            ...
            int key = arr[3]; // Change this value to search for a different key
